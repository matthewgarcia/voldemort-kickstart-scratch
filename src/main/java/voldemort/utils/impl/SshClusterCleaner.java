...
public class SshClusterCleaner extends CommandLineRemoteOperation {
    ...
    public void execute() throws RemoteOperationException {
        ...
        CommandLineParameterizer commandLineParameterizer = new CommandLineParameterizer("SshClusterCleaner.ssh" + (sshPrivateKey != null ? "" : ".nokey"));
